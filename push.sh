...
CGO_ENABLED=0 go build -v -trimpath -ldflags "-X 'github.com/sagernet/sing-box/constant.Version=1.8.14-pro.0' -s -w -buildid=" -tags with_dhcp,with_quic,with_ech ./cmd/sing-box
